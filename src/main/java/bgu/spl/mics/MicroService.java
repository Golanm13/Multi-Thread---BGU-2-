...
public abstract class MicroService implements Runnable {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        messageBus.registerCallback(type, callback, this);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                if (message != null) {
                    Callback<Message> callback = (Callback<Message>) messageBus.getCallback(message.getClass(), this);
                    if (callback != null) {
        ...
        messageBus.unregister(this); // Ensure unregister happens outside the loop
    }
}
